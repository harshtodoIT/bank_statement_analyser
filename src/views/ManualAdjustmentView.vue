...
<template>
  <div class="w-full px-6 py-6 max-w-4xl text-slate-200">
    ...
    <div v-if="hasEntries" class="mt-8 space-y-6">
        ...
        >
          <div>
            <p class="font-medium text-white">
              {{ entry.label }}
              <span class="ml-2 text-xs bg-indigo-500/20 text-indigo-400 px-2 py-0.5 rounded">
                Manual Entry
              </span>
            </p>
      ...
      <!-- TOTAL CARD -->
      <div class="bg-slate-800/60 border border-white/10 rounded-xl p-5 flex justify-between">
        <div>
